                  ...
                  <>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                      <FormControl
                        ...
                        component="fieldset"
                        variant="standard"
                        error={Boolean(touched.isAdminFirstLogin && errors.isAdminFirstLogin)}
                      >
                        <FormControlLabel
                          control={
                            <Switch
                              checked={values.isAdminFirstLogin}
                              onChange={(e) => {
                                setFieldValue('isAdminFirstLogin', e.target.checked);
                              }}
                            />
                          }
                        ...
                        <FormHelperText
                          error={Boolean(touched.isAdminFirstLogin && errors.isAdminFirstLogin)}
                        >
                          {touched.isAdminFirstLogin && errors.isAdminFirstLogin}
                        </FormHelperText>
                      </FormControl>
                    </Grid>
                  </>
